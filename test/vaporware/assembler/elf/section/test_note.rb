...
class Vaporware::Assembler::ELF::Section::NoteTest < Test::Unit::TestCase
  ...
  def setup = @note = Vaporware::Assembler::ELF::Section::Note.new

  def test_gnu_property!
    assert_equal(
      Vaporware::Assembler::ELF::Section::Note.gnu_property,
      reference_binary
    )
    assert_equal(
