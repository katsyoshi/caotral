...
class Vaporware::Compiler::Assembler::ELF::Section::NoteTest < Test::Unit::TestCase
  ...
  def setup = @note = Vaporware::Compiler::Assembler::ELF::Section::Note.new

  def test_gnu_property!
    assert_equal(
      Vaporware::Compiler::Assembler::ELF::Section::Note.gnu_property,
      reference_binary
    )
    assert_equal(
