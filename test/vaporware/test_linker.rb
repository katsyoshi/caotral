...
class Vaporware::LinkerTest < Test::Unit::TestCase
  def test_librarie
    linker = Vaporware::Linker.new(input: "tmp.o")
  ...
  def test_link_command
    linker = Vaporware::Linker.new(input: "tmp.o", output: "tmp")
    ...
    linker = Vaporware::Linker.new(input: "tmp.o", output: "tmp", shared: true)
